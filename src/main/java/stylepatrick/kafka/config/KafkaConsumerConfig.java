...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Car> consumerFactoryCar() {
    ...
    @Bean
    public ConsumerFactory<String, Film> consumerFactoryFilm() {
        Map<String, Object> props = new HashMap<>();
        props.put(
                ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
                bootstrapAddress);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Film> kafkaListenerContainerFactoryFilm() {

        ConcurrentKafkaListenerContainerFactory<String, Film> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactoryFilm());
        return factory;
    }
}
